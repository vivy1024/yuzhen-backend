 ...
 * 同时更新 perfect_enhanced_dataset 和 daml-rag-server/data
 */

$exercisesDir = __DIR__ . '/../storage/app/public/exercises_v2';
$outputFiles = [
    __DIR__ . '/../../perfect_enhanced_dataset/data/enhanced_perfect_exercises_dataset.json',
    __DIR__ . '/../../daml-rag-server/data/enhanced_perfect_exercises_dataset.json',
];
